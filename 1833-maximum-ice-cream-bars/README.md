...
<pre style="position: relative;"><strong>Input:</strong> costs = [1,3,2,4,1], coins = 7
...
<pre style="position: relative;"><strong>Input:</strong> costs = [10,6,8,7,7,8], coins = 5
...
<pre style="position: relative;"><strong>Input:</strong> costs = [1,6,3,1,2,5], coins = 20
